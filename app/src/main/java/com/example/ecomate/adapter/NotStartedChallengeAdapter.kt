...
class NotStartedChallengeAdapter : ListAdapter<ChallengeListItem, NotStartedChallengeAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    class MyViewHolder(private val binding: ItemChallengeNotStartedBinding) :
